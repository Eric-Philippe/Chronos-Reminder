...
fun PrivacyScreen(onBack: () -> Unit) {
    Scaffold(
        ...
        topBar = { ChronosTopBar(title = stringResource(R.string.privacy_policy), onBack = onBack) },
    ) { padding ->
        Column(
            modifier = Modifier
                .fillMaxSize()
            ...
            // Privacy policy content reuses the same sections as ToS since they're combined
            val sections = listOf(
